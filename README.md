...
- [Awesome Bug Bounty Agent Skill](https://github.com/YangTech-gh/Awesome-Bug-Bounty) - Installable agent skill that packages bug-bounty methodology, vulnerability playbooks, and tool guidance for authorized testing.
